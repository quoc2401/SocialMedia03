...
{
    public class MultipleRes : BaseRes
    {
        #region -- Methods --
        ...
        /// Initialize
        /// </summary>
        public MultipleRes() : base() { }

        /// <summary>
        /// Initialize
        /// </summary>
        /// <param name="message">Message</param>
        public MultipleRes(string message) : base(message) { }
        ...
        public MultipleRes(string message, string titleError) : base(message, titleError) { }
